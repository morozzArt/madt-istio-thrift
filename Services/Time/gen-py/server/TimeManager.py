...
class Client(Iface):
  ...
  def get_time(self, name):
    ...
    Parameters:
     - name
    """
    self.send_get_time(name)
    return self.recv_get_time()

  def send_get_time(self, name):
...
class Processor(Iface, TProcessor):
  ...
  def process_get_time(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = get_time_result()
    result.success = self._handler.get_time(args.name)
    oprot.writeMessageBegin("get_time", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
