...
class Country(object):
    ...
    def __init__(self, name=None, id=0, currency=None, capital=None,):
        self.name = name
        self.id = id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.capital = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('Country')
        ...
        if self.capital is not None:
            oprot.writeFieldBegin('capital', TType.STRING, 4)
...
all_structs.append(Country)
Country.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
    (2, TType.I32, 'id', None, 0, ),  # 2
    (3, TType.STRING, 'currency', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'capital', 'UTF8', None, ),  # 4
)
